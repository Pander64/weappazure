...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'ezXCC6HfF3hmgtCqELJ2w9NRUByHM6OlvYrwRHX02ckbTDc3EVDSP4puTbX+SImXqRdhZN3kF38AZs4K9lmL+g=='
    BLOB_CONTAINER = os.environ.get('BLOB_CONTAINER') or 'imagesblobs'
    ...
    CLIENT_SECRET = "u_6-Q6K0xJ4gHu25Nwxd_6B.T9vG_tb.Qn"
    ...
    CLIENT_ID = "7408a900-3439-44a3-9ff9-651f774215b5"
